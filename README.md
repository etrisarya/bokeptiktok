...
A live demo of the project is available at [https://bokeptiktok.pages.dev](https://bokeptiktok.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep tiktok`)
...
1. Fork the [repository](https://github.com/etrisarya/bokeptiktok/fork) on GitHub.
